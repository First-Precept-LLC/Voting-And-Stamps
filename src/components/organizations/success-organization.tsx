const SuccessOrganization=({ onCloseModal, orgData })=>{
    return (
        <>
                ...
                <div className="relative bg-white rounded-lg shadow ">
                    ...
                    <div className="px-6 space-y-6 flex">
                        <div className="flex flex-col  mx-8 items-center text-center">
                            <div className="flex flex-col mb-8">
                                <h2 className="text-3xl mb-2">You have successfully built {orgData?.orgName} Organization!</h2>
                            </div>
                            <div className="flex items-center justify-center">
                                <img src="/img/org-success.svg" alt=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center p-6 space-x-2 rounded-b justify-center  dark:border-gray-600">
                        ...
                        <button type="button"
                            ...
                            data-modal-toggle="large-modal">Goto
                            Organization</button>
                    </div>
                </div>
            </div>
...
export default SuccessOrganization;