...
function ProcessTemplates() {
  ...
  useEffect(() => {
    if (item && item.estimatedDuration) {
      ...
      setestDuration([
        duration[0].split("days")[0],
        duration[1].split("hrs")[0],
        duration[2].split("mins")[0],
      ]);
    }
  }, [item]);
  ...
  const GET_STEPS = gql`
    query steps($nameFilter: String!) {
      steps(
        input: { filter: { parentProcessTemplate: { _eq: $nameFilter } } }
      ) {
        results {
          _id
          name
  ...
  const { data2, error2, loading2 } = useQuery(GET_STEPS, {
    ...
    onCompleted: (dataValue) => {
      ...
      setFields(
        dataValue.steps.results.filter(
          (e) => e.parentProcessTemplate === item._id
        )
      );
    },
  });
  ...
  const CREATE_PROCESS = gql`
    mutation createProcess($userId: String!, $name: String!, $dueDate: Date!) {
      createProcess(
        input: { data: { userId: $userId, name: $name, dueDate: $dueDate } }
      ) {
        data {
          _id
        }
  ...
  let [
    createProces,
    { loading: _loading, data: _data, error: _error },
  ...
  const daysHandler = (value) => {
    ...
    setSelectedStep({
      ...selectedStep,
      estimatedDuration: `${estStepDuration.toString()}`,
    });
    if (selectedStep._id) {
      setFields(
        fields.map((e, index) => {
          if (e._id === selectedStep._id) {
            return { ...e, estimatedDuration: `${arr.toString()}` };
          } else {
            return { ...e };
          }
        })
      ...
      <MainLayout>
        {!createModal ? (
          <div className="flex w-full p-8 flex-col">
            <div className="flex justify-between">
              ...
              <button
                ...
                onClick={() => {
                  setItem({
                    ...item,
                    estimatedDuration: `${estDuration.join()}`,
                  });
                  console.log(item);
                }} //CreatePage}
            ...
            <div className="flex flex-col">
              <div className="flex grid grid-cols-3 gap-4">
                <div className="flex flex-col mb-8">
                  <label for="countries" className="text-xs font-bold mb-2">
                    Project
                  </label>
                  <select
                    value={item.project_id ? item.project : ""}
                    id="countries"
                    onChange={(e) =>
                      setItem({ ...item, parentProject: `${e.target.value}` })
                    }
                  ...
                  >
                    ...
                    {department.map((value) => {
                      return (
                        <option value={department.name}>{value.name}</option>
                      );
                    })}
                ...
                {processShowDate ? (
                  <div
                    ...
                    style={{
                      ...
                      height: "200px",
                      margin: "0px",
                      transform: "translate3d(970.5px, 11px, 0px)",
                    }}
                  >
                    <div className="py-1">
                      <a
                        href="#"
                        className="block px-4 py-2 text-xs text-center text-gray-700 hover:bg-gray-100"
                      >
                        Dynamic Estimated Duration
                      </a>
                    </div>
                    <ul
                      className="py-1 flex text-sm text-gray-700 dark:text-gray-200 justify-between"
                      aria-labelledby="dropdownDividerButton"
                    >
                      <li className="">
                        <a
                          href="#"
                          className="block px-4 py-2 hover:bg-gray-100 text-kelvinDark"
                        >
                          Days
                        </a>
                        <input
                          ...
                          name=""
                          id=""
                          value={parseInt(estDuration[0])}
                          onChange={(e) => {
                            processDaysHandler({ days: `${e.target.value}` });
                          }}
                      ...
                      <li>
                        ...
                        <input
                          ...
                          name=""
                          id=""
                          value={parseInt(estDuration[1])}
                          onChange={(e) => {
                            processHrsHandler({ hrs: `${e.target.value}` });
                          }}
                          className="w-20 bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        />
                      </li>
                      <li>
                        ...
                        <input
                          ...
                          name=""
                          id=""
                          value={parseInt(estDuration[2])}
                          onChange={(e) => {
                            processMinsHandler({ mins: `${e.target.value}` });
                          }}
                          className="w-20 bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        />
                      </li>
            ...
            <div className="flex flex-col">
              <h6 class="text-kelvinDark font-medium">Steps</h6>
                      ...
                      return (
                        ...
                        >
                          <input
                            ...
                            onChange={(e) => {
                              stepNameHandler(e.target.value, item);
                            }}
                          />
                          <button
                            className="px-4"
                          ...
                          {item.showPopup ? (
                            <div style={{ height: "30px", width: "30px" }}>
                              <button
                                ...
                                className=" bg-kelvinMedium hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-md text-sm px-2  h-6 text-left mr-2 w-12 text-center "
                              >
                                delete
                              </button>
                            </div>
                ...
                <div className="flex flex-col bg-kelvinLight p-4">
                  ...
                  <div className="flex flex-col mb-8">
                    ...
                    <div className="relative" onClick={stepEstimatedDate}>
                      ...
                      <input
                        id="dropdownDividerButton"
                        data-dropdown-toggle="dropdownDivider" //onChange={(e) => selectedDurationHandler(e.target.value)}
                  ...
                  {showDate ? (
                    <div
                      ...
                      style={{
                        ...
                        height: "200px",
                        margin: "0px",
                        transform: "translate3d(842.5px, 344px, 0px)",
                      }}
                    >
                      <div className="py-1">
                        <a
                      ...
                      >
                        <li className="">
                          ...
                          <input
                            ...
                            name=""
                            id=""
                            value={parseInt(estStepDuration[0])}
                            onChange={(e) => {
                              daysHandler({ days: `${e.target.value}` });
                            }}
                            className="w-20 bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                          />
                        </li>
                        <li>
                          ...
                          <input
                            ...
                            name=""
                            id=""
                            value={parseInt(estStepDuration[1])}
                            onChange={(e) => {
                              hrsHandler({ hrs: `${e.target.value}` });
                            }}
                            className="w-20 bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                          />
                        </li>
                        <li>
                          ...
                          <input
                            ...
                            name=""
                            id=""
                            value={parseInt(estStepDuration[2])}
                            onChange={(e) => {
                              minsHandler({ mins: `${e.target.value}` });
                            }}
                            className="w-20 bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                          />
                        </li>
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            >
                              <i
                                ...
                                style={{ color: "#0707ae", fontSize: "15px" }}
                              ></i>
                            </button>
                            <button
                              type="button"
