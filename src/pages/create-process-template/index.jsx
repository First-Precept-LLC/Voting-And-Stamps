...
function ProcessTemplates() {
  ...
  ] = useMutation(CREATE_PROCESS_TEMPLATE, {
  ...
  let [createStep, { dataProcess, loadingProcess, errorProcess }] = useMutation(
    CREATE_STEP,
    {
      ...
      onError: (errorProcess) =>
        console.error("Error creating a post step", error),
    }
  );
                  ...
                  <div className="flex flex-col mb-8">
                    ...
                    <div className="relative" onClick={stepEstimatedDate}>
                      ...
                      <input
                        ...
                        data-dropdown-toggle="dropdownDivider"
                        onChange={(e) =>
                          selectedDurationHandler(e.target.value)
                        }
                        ...
                        <li className="">
                          ...
                          <input
                            ...
                            value={
                              ...
                              selectedStep.name !== null
                                ? parseInt(selectedStep.duration[0])
                                : null
                            }
                            onChange={(e) => {
                        ...
                        <li>
                          ...
                          <input
                            ...
                            value={
                              selectedStep &&
                              selectedStep.duration &&
                              selectedStep.duration[1] &&
                              selectedStep.name !== null
                                ? parseInt(selectedStep.duration[1])
                                : null
                            }
                            onChange={(e) => {
                        ...
                        <li>
                          ...
                          <input
                            ...
                            value={
                              selectedStep &&
                              selectedStep.duration &&
                              selectedStep.duration[2] &&
                              selectedStep.name !== null
                                ? parseInt(selectedStep.duration[2])
                                : null
                            }
                            onChange={(e) => {
